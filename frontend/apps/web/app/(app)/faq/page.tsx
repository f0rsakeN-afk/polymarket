export const metadata = {
  title: "FAQ",
  description: "Frequently asked questions about PredictX prediction markets, trading, and platform features.",
}
  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-foreground/90">
        <article>
          <h2 className="text-base font-semibold mb-1">What is PredictX?</h2>
          <p className="text-muted-foreground">PredictX is a prediction market platform where users can trade on the outcomes of real-world events.</p>
        </article>
        <article>
        ...
        <article>
          ...
          <p className="text-muted-foreground">A protocol fee is applied to each trade as displayed at the time of trading. There are no deposit or withdrawal fees from PredictX.</p>
        </article>
        <article>
