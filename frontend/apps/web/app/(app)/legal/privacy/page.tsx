...
export default function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy" lastUpdated="July 2026" sections={sections}>
      <div className="space-y-10 text-sm leading-relaxed text-foreground/90">
        <section id="collection">
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li>
              Transaction data: trades, deposits, withdrawals, and wallet balances.
            </li>
        ...
        <section id="usage">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              To comply with legal and regulatory obligations (including anti-money laundering).
            </li>
            <li>
        ...
        <section id="sharing">
          <h2 className="text-base font-semibold mb-3">3. Data Sharing</h2>
          <p>We may share your information with:</p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>
              Service providers who assist in platform operations (hosting, analytics, payment
              processing).
            </li>
        ...
        <section id="retention">
          ...
          <p>
            ...
            period thereafter to comply with legal obligations, resolve disputes, and enforce
            agreements. Transaction records are retained in accordance with applicable financial
            regulations.
          </p>
        </section>
        ...
        <section id="cookies">
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>
              <strong>Essential cookies:</strong> Required for platform functionality, including
        ...
        <section id="rights">
          ...
          <p className="mt-2">
            ...
            <a href="mailto:privacy@predictx.io" className="text-primary hover:underline">
              privacy@predictx.io
            </a>
            .
          </p>
        ...
        <section id="security">
          <h2 className="text-base font-semibold mb-3">7. Data Security</h2>
          <p>
        ...
        <section id="transfers">
          ...
          <p>
            Your data may be processed in jurisdictions other than your own. We ensure appropriate
            safeguards are in place, including Standard Contractual Clauses or equivalent
        ...
        <section id="children">
          <h2 className="text-base font-semibold mb-3">10. Children&rsquo;s Privacy</h2>
          <p>
            The platform is not intended for individuals under 18. We do not knowingly collect
            personal data from children. If we become aware that a child has provided us with
            personal data, we will delete it.
          </p>
        </section>
