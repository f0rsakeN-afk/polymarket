    ...
    <div className="container mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-foreground/90">
        <section>
          ...
          <p>
            By accessing or using PredictX, you agree to be bound by these Terms of Service (&ldquo;Terms&rdquo;). If you do not agree, you may not use the platform.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>PredictX reserves the right to cancel or void markets in cases of manifest error, manipulation, or technical failure.</li>
        ...
        <section>
          ...
          <p>
            PredictX charges a protocol fee on each trade as disclosed on the platform. Fees are subject to change with reasonable notice. You are responsible for any applicable taxes.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Markets are resolved by authorized administrators based on the resolution criteria. Resolution decisions are final and binding. In the event of a dispute, PredictX&rsquo;s internal review process shall be the sole remedy.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            All content on the platform, including but not limited to text, graphics, logos, and software, is the property of PredictX or its licensors and is protected by intellectual property laws.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            PredictX and its affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the platform. The platform is provided &ldquo;as is&rdquo; without warranties of any kind, either express or implied.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            For questions about these Terms, please contact privacy@predictx.io.
          </p>
        </section>
      </div>
    </div>
