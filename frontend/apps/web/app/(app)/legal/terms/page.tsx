    ...
    >
      <div className="space-y-10 text-sm leading-relaxed text-foreground/90">
        ...
        <section id="eligibility">
          <h2 className="mb-3 text-base font-semibold">2. Eligibility</h2>
        ...
        <section id="trading">
          <h2 className="mb-3 text-base font-semibold">4. Trading Rules</h2>
          <ul className="list-disc space-y-1 pl-5">
            <li>
              All trades are final once executed on the blockchain or platform
              order book.
            </li>
            <li>
              Market outcomes are determined by the resolution criteria
            ...
            <li>
              Users may not engage in wash trading, front-running, or any form
              of market manipulation.
            </li>
            <li>
              Limit orders are placed at your specified price and may be
              partially filled.
            </li>
          </ul>
        </section>
        ...
        <section id="resolution">
          <h2 className="mb-3 text-base font-semibold">6. Market Resolution</h2>
          <p>
        ...
        <section id="prohibited">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <li>
              Interfere with the proper functioning of the platform, including
              introducing malware or conducting denial-of-service attacks.
            </li>
            <li>
              Use automated scripts or bots without express written permission.
            </li>
            <li>
              Provide false or misleading information during account
              registration or KYC.
            </li>
          </ul>
        </section>
        ...
        <section id="termination">
          <h2 className="mb-3 text-base font-semibold">10. Termination</h2>
          <p>
            We reserve the right to suspend or terminate your account at any
            time for violation of these Terms or for any other reason. Upon
        ...
        <section id="disputes">
          ...
          <p>
            ...
            Arbitration Association. You waive any right to participate in a
            class action or class-wide arbitration.
          </p>
        </section>

        <section id="changes">
          <h2 className="mb-3 text-base font-semibold">12. Changes to Terms</h2>
          <p>
            We may modify these Terms at any time. Material changes will be
            notified via email or platform notice. Continued use after changes
            constitutes acceptance of the new Terms.
          </p>
        </section>

        <section id="contact">
          <h2 className="mb-3 text-base font-semibold">13. Contact</h2>
          <p>
            For questions about these Terms, please contact{" "}
            <a
              href="mailto:legal@predictx.io"
